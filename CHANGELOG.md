...
### Fixed
- **Tailwind CSS Dark Mode Configuration**: Reordered Tailwind CDN script inclusion prior to `tailwind.config = { darkMode: 'class' }` inline setup across all HTML pages (`index.html`, `web-services.html`, `qa-testing.html`, `infrastructure.html`, `contact.html`), restoring light/dark theme toggle functionality.
